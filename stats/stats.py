...
def print_summary_metrics(metrics):
    ...
    print(f"{avg_bw_str}, {std_bw_str}, {throughput_mbps}, {goodput_mbps}, {avg_cwnd_kbit},{std_cwnd_kbit}, {avg_rtt_ms}, {std_rtt_ms}, {loss_rate_percent}, {retransmissions}, {total_time_s}")
